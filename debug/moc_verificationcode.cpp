...
const QMetaObject VerificationCode::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_VerificationCode.data,
      qt_meta_data_VerificationCode,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *VerificationCode::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VerificationCode.stringdata0))
        return static_cast<void*>(const_cast< VerificationCode*>(this));
