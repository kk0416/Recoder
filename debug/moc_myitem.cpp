...
QT_MOC_LITERAL(1, 7, 15), // "MyItemcolliding"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 7), // "advance"
QT_MOC_LITERAL(4, 32, 5) // "phase"

    },
    "MyItem\0MyItemcolliding\0\0advance\0phase"
};
...
void MyItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->MyItemcolliding(); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyItem::MyItemcolliding)) {
                *result = 0;
                return;
            }
        }
