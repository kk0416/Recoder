...
QT_MOC_LITERAL(1, 12, 9), // "BtnOkSlot"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 13) // "BtnCancelSlot"

    },
    "registerWin\0BtnOkSlot\0\0BtnCancelSlot"
};
...
void registerWin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        registerWin *_t = static_cast<registerWin *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->BtnOkSlot(); break;
...
const QMetaObject registerWin::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_registerWin.data,
      qt_meta_data_registerWin,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
